...
plot_elo_multi(c("Jacob", "Vergil", "Craig"))

```

Maya's accumulated point differential over time
...
# Only keep teammate pairs with games together
no_of_games <- 10
teammate_df <- teammate_df %>%
  filter(Games >= no_of_games)
